...
\begin{enumerate}
	\item Pokud rámec na dně obsahuje \uv{dostatečný počet} podstavů (viz dále), přidělí žadateli
...
Typicky se v takovém případě stane, že vstup má tak \uv{šťastnou} podobu, že při sekvenčním řešení
